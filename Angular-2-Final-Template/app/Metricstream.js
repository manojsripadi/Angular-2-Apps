...
var Metricstream = (function () {
    function Metricstream(__service) {
        this.__service = __service;
    }
    Metricstream.prototype.ngOnInit = function () {
        var _this = this;
        this.__service.getDetails().
            subscribe(function (response) { return _this.childData = response; });
    };
    return Metricstream;
}());
Metricstream = __decorate([
    core_1.Component({
